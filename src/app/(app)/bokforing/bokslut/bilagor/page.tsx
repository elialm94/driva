...
} from "@/components/bokslutsbilaga-widgets";
  ...
  return (
    <div>
              ...
              <li key={s.id} className="flex items-start gap-2.5 text-[13.5px]">
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="block text-[12px] text-muted">
                    Bokförd {s.bookedAt ? datumKort(s.bookedAt) : ""} ·{" "}
                    {s.verificationIds.length} verifikat
                  </span>
                </span>
              </li>
            ))}
      ...
      <div className="mb-6 space-y-4">
        {employee ? (
          ...
          <Card className="px-6 py-5">
            ...
            <p className="mt-1 text-[13px] text-soft">
              ...
              <Link href="/bokforing/lon" className="font-medium text-accent hover:underline">
                Lägg upp lön
              </Link>{" "}
              om det ska finnas.
            </p>
        ...
        <DoubtfulReceivablesForm fiscalYearId={fy.id} suggestions={doubtfulRows} selected={alreadyPicked} />
      ...
      <Card className="mb-6 px-6 py-5">
        ...
        <div className="mt-4">
          <ManualAccrualForm fiscalYearId={fy.id} yearEnd={fy.endDate} />
        </div>
      </Card>
