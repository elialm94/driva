...
export async function applyPendingPageLoadSchema(client: SqlClient): Promise<string[]> {
  ...
  // Produktomfattning: svar mot supportmatrisen + konsultgodkännanden (migration 57).
  await ensureColumn(
    "business_settings",
    "scope",
...
/**
 * Publika demosessioner (migration 40): EN jsonb-rad per besökare som alla
...
/** Samma kropp som migration 38 – 37:s reset + grossisttabellerna. */
...
/**
 * Onboarding, Kom igång och dataimport (migration 39). Speglar migrationen
...
/** Migration 39:s reset – 38:s reset plus dataimporter, leverantörer och onboarding-raden. */
