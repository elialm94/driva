...
export const quotesSpec: TableSpec<Quote & { amountToPay: number }> = {
  ...
  columns: [
    ...
    "follow_ups", "last_email", "deliveries", "last_send_attempt_at", "amount_to_pay", "created_at",
  ],
  toRow: (q, businessId) => ({
    id: q.id,
    business_id: businessId,
    ...
    deliveries: jsonParamOrNull(q.deliveries),
  ...
  fromRow: (r) => ({
    ...
    ...opt("deliveries", jsonOrU<NonNullable<Quote["deliveries"]>>(r.deliveries)),
...
export const invoicesSpec: TableSpec<Invoice & { amountToPay: number }> = {
  ...
  columns: [
    ...
    "issued_at", "sent_at", "last_sent_at", "last_email", "deliveries", "last_send_attempt_at", "paid_at", "reminders", "token", "ocr",
  ...
  toRow: (inv, businessId) => ({
    ...
    deliveries: jsonParamOrNull(inv.deliveries),
  ...
  fromRow: (r) => ({
    ...
    ...opt("deliveries", jsonOrU<NonNullable<Invoice["deliveries"]>>(r.deliveries)),
    ...opt("lastSendAttemptAt", tsIsoOrU(r.last_send_attempt_at)),
