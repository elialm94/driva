...
/**
 * Felgräns för publika kunddokument. Ingen FervaMark – märket i rotens
 * error.tsx skulle annars följa med i RSC-svaret på /offert/[token] m.fl.
 */
    ...
    <main className="flex min-h-dvh flex-col items-center justify-center bg-stone-100 px-4 py-10">
      <div className="w-full max-w-sm rounded-2xl border border-stone-200 bg-white p-6 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm text-stone-500">
          Något gick fel när sidan hämtades. Ladda om, eller be avsändaren skicka länken igen.
        </p>
