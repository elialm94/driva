...
import { PdfPrintBar } from "./pdf-print-bar";
...
export function ArsredovisningPdfView({
  fy,
  report,
  backHref,
}: {
  fy: FiscalYear;
  report: AnnualReport;
  /** Tillbaka till årsredovisningen på den yta utskriften öppnades från. */
  backHref: string;
}) {
...
`;
  ...
  return (
    <div className="min-h-dvh bg-[#eae7df] print:bg-white">
      ...
      <PdfPrintBar backHref={backHref} backLabel="Tillbaka till årsredovisningen" />
