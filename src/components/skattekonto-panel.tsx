...
export function SkattekontoPanel() {
  ...
  return (
    <div>
      ...
      {fSkattPerMonth <= 0 ? (
        <FSkattSettingCard amount={fSkattPerMonth} autoBook={autoBookFSkatt} className="mb-8" />
      ) : null}
      ...
      {fSkattPerMonth > 0 ? (
        <div className="mt-8">
          ...
          <FSkattSettingCard amount={fSkattPerMonth} autoBook={autoBookFSkatt} />
        </div>
      ) : null}
