...
/** Resultatrapporten – samma vy på ägar- och konsultytan. */
export function ResultatView({ ws, searchParams: params }: { ws: AccountingWorkspace; searchParams: { ar?: string } }) {
  const { years, fy, resultat: rr } = rapporterViewModel(params);
  const base = wsHref(ws, "/bokforing/resultat");
